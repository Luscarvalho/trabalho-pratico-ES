...
<html>
    ...
    <body style="background-image: url(imagens/fundo-login.jpg); background-size: cover;">
        ...
        <div class="valign-wrapper row" style="position: relative; min-height: 100vh;">
            ...
            <!-- FORMULÁRIO -->
                <form method="POST" action="controller/editarTipo.php?id=<?php echo $tipo['tipoId']; ?>" autocomplete="off">

                <!-- TIPO -->
                    <div class="input-field col s12">
                        <i class="material-icons prefix">bubble_chart</i>
                        <input type="text" name="cTipo" placeholder="Tipo" value="<?php echo $tipo['tipoNome']; ?>" required>
                    </div>
