...
<html>
    ...
    <body style="background-image: url(imagens/fundo-login.jpg); background-size: cover;">
        ...
        <div class="valign-wrapper row" style="position: relative; min-height: 100vh;">
            ...
            <!-- FORMULÁRIO -->
                <form method="POST" action="../controller/controladorTipo.php?btn=cadastrarTipo" enctype="multipart/form-data" autocomplete="off">
                ...
                <!-- BOTÕES -->
                    <div class="file-field input-field col s12">
                        <button type="submit" class="btn" name="btnCadastrarTipo"> Adicionar </button>
